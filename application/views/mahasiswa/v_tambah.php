    ...
    <body class="container-md" style="background-image: url('<?php echo base_url('assets/img/bg.jpg');?>');">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="<?= site_url('AController/barang') ?>">Home <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="card">
            ...
            <form action="<?=site_url('AController/proses')?>" method="post" class="container-md">
                ...
                <a href="<?= site_url('AController/barang') ?>" class="btn btn-warning">Batal</a>
            </form>
            <br>
        </div>
